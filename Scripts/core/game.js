...
var sunOverMaterial;
var sunFakeGas1;
var sunFakeGas1Geometry;
var sunFakeGas1Material;
var sunFakeGas2;
var sunFakeGas2Geometry;
var sunFakeGas2Material;
// Moon Objects
var praxidice;
var ioke;
var hormes;
...
var alala;
var alalaOver;
var alalaOverGeometry;
var alalaOverMaterial;
...
function init() {
    ...
    nike = new gameObject(new SphereGeometry(45, 100, 100), new LambertMaterial({ map: nikeBaseTexture }), 300, 100, 200);
    nike.name = "Nike";
    ...
    kratos = new gameObject(new SphereGeometry(32, 100, 100), new LambertMaterial({ map: kratosBaseTexture }), 500, 100, 200);
    kratos.name = "Kratos";
    ...
    zelos = new gameObject(new SphereGeometry(60, 100, 100), new LambertMaterial({ map: zelosBaseTexture }), 600, 100, 200);
    zelos.name = "Zelos";
    ...
    bia = new gameObject(new SphereGeometry(75, 100, 100), new LambertMaterial({ map: biaBaseTexture }), 800, 100, 200);
    bia.name = "Bia";
    ...
    alala = new gameObject(new SphereGeometry(85, 100, 100), new LambertMaterial({ map: alalaBaseTexture }), 1000, 100, 200);
    alala.name = "Alala";
    ...
    ioke = new gameObject(new SphereGeometry(8, 100, 100), new LambertMaterial({ map: iokeBaseTexture }), 100, 25, 25);
    ioke.name = "Ioke";
    // Add Moon for Alala - Hormes (Effort)
    hormes = new gameObject(new SphereGeometry(35, 100, 100), new LambertMaterial({ map: hormesBaseTexture }), 250, 25, 10);
    hormes.name = "Hormes";
    // Add Orbits to Sun 
    sun.add(styxOrbit);
    sun.add(nikeOrbit);
